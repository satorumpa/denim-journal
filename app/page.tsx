...
// Tvinga Next.js att fatta att sidan hämtar live-data och inte ska förhandsbyggas statiskt
...
export default function Home() {
  // Säkra att vi ALLTID startar med en tom array [] och aldrig undefined
  ...
  return (
    <main className="relative min-h-screen w-full overflow-x-hidden bg-slate-950">
      ...
      {/* Kollaget skickar med en tom array som fallbacksäkring om entries inte laddat */}
